            ...
            <div class="container mt-5">
                <div>
                    <div class="flex-column row justify-content-between mab-2"> <!-- aquí va la parte de view, referencia-->
                        ...
                        <form action="javascript:void(0);" id="formSec" class="p-3 bg-secondary rounded mb-4" onsubmit="app.guardar()">
                            <div class="mb-3">
                                <input type="hidden" id="id" />
                                <label for="titulo" class="form-label">Título</label>
                                <input type="text" class="form-control" id="titulo" placeholder="Título de la Sección" autofocus required />
                            </div>
                            <label for="nombre" class="form-label">Nombre de la Sección</label>
                            <input type="text" class="form-control mb-2" id="nombre" placeholder="Sección" required />
                ...
                <table class="table table-hover table-bordered w-60 mx-auto">
                    <thead>
                        <tr>
                            ...
                            <th class="text-center" scope="col">NOMBRE_SECCIÓN</th>
